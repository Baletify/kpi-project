...
<body>
    <table class="table-auto w-96">
        ...
        <tr>
            <td class="border-none">
               <span class="padding">Data Sudah Di Cek</span>
            </td>
            <td class="border-none">
                <span class="padding">:</span>
            </td>   
            <td class="border-none">
                <span class="padding">{{ $checked }}</span>
            </td>
        </tr>
        <tr>
            <td class="border-bottom-solid">
    ...
    <span style="font-style: italic">Note: TTE Ini digunakan sebagai bukti penyelesaian pengecekan KPI</span>
</body>
</html>